                    ...
                    <form @submit.prevent="handleRegister" class="space-y-4 md:space-y-6">
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input v-model="termsAccepted" id="terms" type="checkbox"
                            ...
                            <div class="ml-3 text-sm">
                                <label for="terms" class="font-light text-gray-500 dark:text-gray-300">
                                    I accept the <a href="#"
                                        class="font-medium text-primary-600 hover:underline dark:text-primary-500">Terms
                                        and Conditions</a>
                                </label>
                            </div>
                        </div>
                        <button type="submit" :disabled="isLoading || password !== confirmPassword || !termsAccepted"
                        ...
                        <div v-if="password !== confirmPassword && confirmPassword" class="text-red-500 text-sm">
...
const handleRegister = async () => {
    ...
    try {
        ...
        // Remove the variable assignment and just make the call
